...
class ViewVariableCallsTest : Cake5BaseTestCase() {
    private val root = "cake5/templates"
    private val extension = "php"
    private val elementKey = "element/review"
    private val settings get() = Settings.getInstance(project)

    override fun setUpTestFiles() {
        myFixture.configureByFiles("cake5/vendor/cakephp.php")
    ...
    private fun controller(body: String) {
        ...
        myFixture.addFileToProject("cake5/src5/Controller/MovieController.php",
