...
class NestedAppDirectoryTest : BaseTestCase() {
    ...
    override fun setUp() {
        ...
        newState.appDirectory = "app/src4"  // Nested path
    ...
    private fun setUpTestFiles() {
        myFixture.configureByFiles(
            "cake4_nested/app/src4/Controller/AppController.php",
            "cake4_nested/app/src4/Model/Table/MoviesTable.php",
            "cake4_nested/templates/Movie/index.php",
            "cake4_nested/vendor/cakephp.php"
        )
    }

    fun `test completing a cake4 table with nested app directory`() {
        myFixture.configureByFilePathAndText("cake4_nested/app/src4/Controller/MovieController.php", """
        <?php
    ...
    fun `test view variable completion with nested app directory`() {
        ...
        myFixture.configureByFilePathAndText("cake4_nested/templates/Movie/index.php", """
        <?php
        echo ${'$'}<caret>
        """.trimIndent())
