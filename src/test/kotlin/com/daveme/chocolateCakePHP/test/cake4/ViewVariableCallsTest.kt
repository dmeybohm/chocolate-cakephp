...
class ViewVariableCallsTest : Cake4BaseTestCase() {
    private val root = "cake4/templates"
    private val extension = "php"
    private val elementKey = "element/review"
    private val settings get() = Settings.getInstance(project)

    override fun setUpTestFiles() {
        myFixture.configureByFiles("cake4/vendor/cakephp.php")
    ...
    private fun controller(body: String) {
        ...
        myFixture.addFileToProject("cake4/src4/Controller/MovieController.php",
